...
from transemon.cleaner.masking import SegMaskingCleaner, SegHashMaskingCleaner, HashMaskingCleaner, MoneyMaskingCleaner, \
    NameMaskingCleaner, PhoneMaskingCleaner, Sha3AllMaskingCleaner
...
class TestCleaner(unittest.TestCase):
    def test_seg_masking(self):
        ...
        mask_value = masker.clean(src_value)
        print(mask_value)
    ...
    def test_sha3_hash_masking(self):
        masker = Sha3AllMaskingCleaner()
        src_value = '北京市朝阳区北沙滩甲 4 号'
        mask_value = masker.clean(src_value)
        print(mask_value)
